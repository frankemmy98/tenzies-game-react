...
export default function App() {
  ...
  // const [getTime, setGetTime] = React.useState(localStorage.getItem("time"));

  // set all dice held condition
  React.useEffect(() => {
  ...
  // get time and update time on tenzies state
  // React.useEffect(() => {
  //   if (tenzies) {
  //     setGetTime(localStorage.getItem("time"));
  //   }
  // }, [tenzies]);
  ...
  return (
    <main className="dice--bg">
      ...
      {/* <div className="Saved-timer">
        {getTime && !highScore && <p>High Score: {getTime}</p>}
        {highScore && <p>High Score: {}</p>}
      </div> */}
